...
async function loadReviews() {
  ...
  reviewsList.innerHTML = "<p style='color:#b87a00'>⏳ Допиши GET /api/reviews/ на бэке и loadReviews() здесь</p>";
}
...
// ══════════════════════════════════════════════════════════════
// ЗАДАНИЕ — форма отзыва:
//
// 1. Раскомментируй форму в index.html
//
// 2. Реализуй выбор звёзд (star-picker):
//
...
//      // Подсветить звёзды: добавь класс "lit" всем ≤ currentRating
//      document.querySelectorAll(".pick-star").forEach(s => {
//        s.classList.toggle("lit", Number(s.dataset.value) <= currentRating);
//      });
//    });
//
// 3. Обработчик submit формы:
//
...
//      e.preventDefault();
//      if (currentRating === 0) { alert("Выбери рейтинг!"); return; }
//
...
//      reviewForm.reset();
//      currentRating = 0;
//      document.querySelectorAll(".pick-star").forEach(s => s.classList.remove("lit"));
//      loadReviews();
//      loadStats();
//    });
// ══════════════════════════════════════════════════════════════
